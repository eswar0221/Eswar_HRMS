...
app.post("/sendmailleave", (req, res) => {
  console.log("request came");
  let user = req.body;
  sendMailLeave(user, info => {
    console.log('The mail has beed send 😃 and the id is ${info.messageId}');
    res.send(info);
  });
});
...
async function sendMail(user, callback) {
  ...
  color: white;">
      <img src="./uplogou.png" class="imgi" style="width: 20%;">
      <div class="text-center mt-md-3">Welcome to Upsteer Organization </div><br/>
  </div>
  <div class="card-body"><br/>
      ...
      <table class="my-md-3">
          ...
          font-weight: 400;">
              <tr>
                  <td>Email</td>
                  <td><span class="ml-md-2">:</span> ${user.email} </td>
              </tr>
              <tr>
              <td>Employee ID</td>
...
async function sendMailLeave(user, callback) {
  // create reusable transporter object using the default SMTP transport
  ...
  background-color: #512da8;
  color: white;">
      <img src="./uplogou.png" alt="logo" class="imgi" style="width: 20%;">
      <div class="text-center mt-md-3">Welcome to Upsteer Organization </div><br/>
  </div>
  <div class="card-body"><br/>
      ...
      <table class="my-md-3">
          ...
          font-weight: 400;">
              ...
              <tr>
                  <td>Status</td>
                  <td><span class="ml-md-2">:</span>  ${user.status} </td>
              </tr>
          </tbody>
      </table><br/>
  ...
  // send mail with defined transport object
  let info = await transporter.sendMailLeave(mailOptions);
