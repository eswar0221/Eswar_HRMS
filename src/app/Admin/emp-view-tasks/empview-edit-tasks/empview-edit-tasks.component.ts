...
@Component({
  selector: 'app-empview-edit-tasks',
  templateUrl: './empview-edit-tasks.component.html',
  styleUrls: ['./empview-edit-tasks.component.css']
})
export class EmpviewEditTasksComponent implements OnInit {
...
getDataIndividual(){
  ...
  var id= localStorage.getItem("caseno1_e")
  let data={
    "Task_Name":id
  }
