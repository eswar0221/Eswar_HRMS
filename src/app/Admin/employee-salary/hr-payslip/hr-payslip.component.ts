...
@Component({
  ...
  styleUrls: ['./hr-payslip.component.css']
})
export class HrPayslipComponent implements OnInit {
  range = [];
  gtyu:Boolean;
  ghjklj:Boolean;
  mon:any;
  ...
  public Edata : Array<any> = [];salIDnet:any;
// Edata:any;
  ngOnInit() {
    this.getempdaid();
  ...
  ddfgf:Array<any>=[];
  nodaemp:Array<any>=[];cau_leaves:any;medi_leaves:any;cau_leaves1:any;medi_leaves2:any;
    getempdaid(){
      ...
      this.web3.gethmbyid(data).subscribe((resl)=>{
...
if (this.mon== "December") {
  ...
  getDataIndividual(){
    ...
    approvedata:Array<any>=[];approvedatam:Array<any>=[]; approvedatac:Array<any>=[];eswa_cas:any;
    getnetsal:any;netesal:any;perdatsal:any;Totalleve:any;Leave1:any; Leave2:any; Leave:any;net_detec:any;lospay:any; lospay1:any; lospay2:any;
