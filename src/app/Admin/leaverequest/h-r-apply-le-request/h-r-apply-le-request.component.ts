...
@Component({
  selector: 'app-h-r-apply-le-request',
  templateUrl: './h-r-apply-le-request.component.html',
  styleUrls: ['./h-r-apply-le-request.component.css']
})
export class HRApplyLeRequestComponent implements OnInit {
...
// }
  ...
  apply(ServiceData){
    ...
    this.router.navigate(['Admin/Leaves_Hr_all'])
  ...
  getDataIndividual1(){
    ...
    this.http.gethmByname(data1).subscribe((res)=>{
    //  this.DataById=res[0].email;
