...
@Component({
  selector: 'app-add-hr-leaves',
  templateUrl: './add-hr-leaves.component.html',
  styleUrls: ['./add-hr-leaves.component.css']
})
export class AddHrLeavesComponent implements OnInit {
  ServiceData:any = {
    // noofleaves:14
...
// }
  ...
  apply(ServiceData){
    ...
    // this.http.updatehrmanLeaves(ServiceData).subscribe((res1)=>{
    //   console.log(res1);
